...
import com.yuex.common.response.JsSdkInitResVO;
import com.yuex.common.util.SHA1Util;
...
public class WxController {
    ...
    private String getAccessToken() {
        ...
        // 去redis里取accessToken
        String accessToken = stringRedisCache.getCacheObject(redisKey);
        if (StringUtils.isEmpty(accessToken)) {
            ...
            stringRedisCache.setCacheObject(redisKey, accessToken, expires, TimeUnit.SECONDS);
            stringRedisCache.expire(redisKey, expires);
        }
        return accessToken;
    }
    ...
    private String getTicket() {
        ...
        String ticket = stringRedisCache.getCacheObject(ticketRedisKey);
        ...
        if (errcode == 0) {
            ...
            Long expires = resultJsonObject.getObject("expires_in", Long.class);
            stringRedisCache.setCacheObject(ticketRedisKey, ticket);
            stringRedisCache.expire(ticketRedisKey, expires);
        } else {
