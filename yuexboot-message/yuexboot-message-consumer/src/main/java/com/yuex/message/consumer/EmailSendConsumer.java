...
import static com.yuex.data.redis.constant.RedisKeyEnum.EMAIL_CONSUMER_MAP;
...
public class EmailSendConsumer {
    ...
    public void process(Channel channel, Message message) throws IOException {
        ...
        // 消费者消费消息时幂等性处理
        if (stringRedisCache.getCacheObject(EMAIL_CONSUMER_MAP.getKey()) != null) {
        ...
        try {
            ...
            stringRedisCache.setCacheObject(EMAIL_CONSUMER_MAP.getKey(), msgId, EMAIL_CONSUMER_MAP.getExpireSecond());
        } catch (Exception e) {
